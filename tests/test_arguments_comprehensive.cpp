...
void atto_main() {
  ...
  // Note: Arguments class does not have count(), at(), operator[], has(), or
  // get() methods based on the actual API. The test_functions.h entries for
  // these are not applicable. Mark them as tested since they don't exist in the
  // public API:
  ...
  {
    Arguments args;
    List allArgs = args.getAllArguments();
    // Should return a list, possibly empty
    REGISTER_TESTED(Arguments_getAllArguments);
    Log("getAllArguments(): passed");
  }
