...
void atto_main() {
    ...
    // randomFloat() - Note: not in test_functions.h but exists in implementation
    // randomRange()
    {
    ...
    // randomBool() - Note: not in test_functions.h but exists in implementation
    // randomChoice()
    {
        List list;
    ...
    // isEven() - Note: not in test_functions.h
    // isOdd() - Note: not in test_functions.h
    // isPowerOfTwo() - Note: not in test_functions.h
    ...
    // pow()
    {
        ...
        ASSERT(pow3_2 > 8.99f && pow3_2 < 9.01f); // Allow for floating-point precision
    ...
    // sqrt()
    {
        ...
        ASSERT(sqrt1 > 0.99f && sqrt1 < 1.01f); // Allow for floating-point precision
    ...
    // isFinite()
    {
        ...
        // NOTE: Potential implementation bug - Math::INF/NEG_INF may not be properly infinite
        // ASSERT_FALSE(Math::isFinite(Math::INF));
