...
void atto_main() {
    ...
    // getExtension()
    {
        ...
        ASSERT_TRUE(ext.equals(String(ATTO_TEXT("txt"))) || ext.equals(String(ATTO_TEXT(".txt"))));
    ...
    // WORKAROUND: Give OS time to flush file buffers before ExitProcess() kills everything
    Sleep(100);
